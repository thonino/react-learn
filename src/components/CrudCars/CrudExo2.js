...
function CrudExo2() {
  ...
  // Créer <button> avec attribut "onClick"
  // Ajouter "handleChoice" et envoyer "data" : onClick={() => handleChoice(data)}
  // Stocker handleChoice et récupérer props : const handleChoice =(data)=>{}
  // Créer alert : alert(`Vous avez choisi : ${data.nom}`)
